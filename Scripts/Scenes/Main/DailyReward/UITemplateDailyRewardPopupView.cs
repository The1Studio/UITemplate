namespace TheOneStudio.UITemplate.UITemplate.Scenes.Main.DailyReward
{
    ...
    {
        [FormerlySerializedAs("dailyRewardItemAdapter")] [FormerlySerializedAs("dailyRewardAdapter")] public UITemplateDailyRewardPackAdapter dailyRewardPackAdapter;
    ...
    public class UITemplateDailyRewardPopupPresenter : UITemplateBasePopupPresenter<UITemplateDailyRewardPopupView, UITemplateDailyRewardPopupModel>
    {
        ...
        {
            base.OnViewReady();
            this.levelDataController.UnlockFeature(UnlockType.DailyReward);
        ...
        private void InitListDailyReward(List<UITemplateDailyRewardPackModel> dailyRewardModels)
        {
