...
namespace BuildReportTool
{
    ...
    {
        private static readonly FileFilterGroup DefaultFileFilters = new(CreateDefaultFileFilters());

        private static FileFilterGroup GetDefaultFileFilterGroup()
        {
            return DefaultFileFilters;
        }

        private static FileFilters[] CreateDefaultFileFilters()
        {
            return new[]
            {
        ...
        private static void SaveFileFilterGroupToFile(string saveFilePath, FileFilterGroup filterGroup)
        {
            var x = new XmlSerializer(typeof(FileFilterGroup));
        ...
        private static FileFilterGroup AttemptLoadFileFiltersFromFile(string filePath)
        {
            FileFilterGroup ret;
        ...
        private const string FILE_FILTERS_USED_FILENAME = "FileFiltersUsed.xml";
        ...
        public static string GetProperFileFilterGroupToUseFilePath(string userFileFilterSavePath)
        {
            ...
            var fileFilterGroupAtDefaultAssetsPath =
                Options.BUILD_REPORT_TOOL_DEFAULT_PATH + "/" + FILE_FILTERS_USED_FILENAME;

            if (File.Exists(fileFilterGroupAtDefaultAssetsPath)) return fileFilterGroupAtDefaultAssetsPath;
            ...
            */
            ...
            var fileFilterGroupAtUserPersonalFolder = userFileFilterSavePath + "/" + FILE_FILTERS_USED_FILENAME;
            ...
            var fileFilterGroupAtUserPersonalFolderDefaultName =
                Util.GetUserHomeFolder() + "/" + Options.BUILD_REPORTS_DEFAULT_FOLDER_NAME + "/" + FILE_FILTERS_USED_FILENAME;
        ...
        {
            var fileFilterGroupPath = GetProperFileFilterGroupToUseFilePath(userFileFilterSavePath);

            //Debug.Log("fileFilterGroupPath: " + fileFilterGroupPath);

            var ret = AttemptLoadFileFiltersFromFile(fileFilterGroupPath);
