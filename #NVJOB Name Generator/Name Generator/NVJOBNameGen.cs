...
public static class NVJOBNameGen
{
    ...
    {
        "Alicia", "Amanda", "Amy", "Angela", "Anna", "Anne", "Annie", "April", "Audrey", "Barbara", "Becky", "Belinda",
    ...
    {
        "Aaliyah", "Abby", "Abigail", "Addison", "Adriana", "Adrianna", "Alana", "Alejandra", "Alexa", "Alexandra",
    ...
    {
        "Aaron", "Adam", "Alan", "Albert", "Alexander", "Alfred", "Allan", "Allen", "Alvin", "Andre", "Andrew", "Anthony",
    ...
    {
        "Aaron", "Abraham", "Adam", "Adrian", "Aidan", "Aiden", "Alan", "Alec", "Alejandro", "Alex", "Alexander", "Alexis",
    ...
    private static string[] firstName5 =
    {
        "Aerilaya", "Aelrie", "Aelua", "Aelynthi", "Aenwyn", "Aerith", "Ahrendue", "Ahshala", "Aila", "Alagossa",
    ...
    private static string[] firstName6 =
    {
        "Adorellan", "Abarat", "Adamar", "Adresin", "Aelrindel", "Aerendyl", "Aeson", "Afamrail", "Agandaur",
    ...
    {
        "Abbott", "Adams", "Adkins", "Aguirre", "Albert", "Alexander", "Alford", "Allen", "Allison", "Alston", "Anderson",
    ...
    public static string GiveAName(int type)
    {
        ...
        if (type > 0)
        {
            ...
            else if (type == 5 || type == 6) //  Fantasy Names ---------------------------
            {
                ...
                //  Second Name 0 (98)
                var secondName0 = new string[]
                {
                    "Ad", "Al", "Ae", "An", "Ara", "Ana", "Am", "Bal", "Bei", "Bi", "Bry", "Cai", "Car", "Chae", "Cra",
                ...
                //  Second Name 1 (100)
                var secondName1 = new string[]
                {
                    "beros", "bella", "balar", "banise", "can", "ceran", "cyne", "caryn", "dan", "di", "dithas", "dove",
                ...
                var secondName = secondName0[Random.Range(0, secondName0.Length)] + secondName1[Random.Range(0, secondName1.Length)];
            ...
            else if (type == 7) //  Sci Fi Names ---------------------------
            {
                ...
                {
                    "gh", "br", "c", "cr", "dr", "g", "gr", "kr", "k", "kh", "n", "q", "qh", "sc", "scr", "str", "st", "t",
                    "tr", "thr", "v", "vr", "x", "z", "", "", "", "", "",
                };
                var name2 = new string[]
                {
                    "a", "e", "ae", "ao", "ai", "au", "uo", "a", "e", "i", "o", "u", "i", "o", "u", "a", "e", "i", "o", "u",
                    "a", "e", "i", "o", "u", "a", "e", "i", "o", "u", "a", "e", "i", "o", "u",
                };
                var name3 = new string[]
                {
                    "cr", "cz", "dr", "gr", "c", "k", "n", "q", "t", "v", "x", "z", "c", "cc", "gn", "gm", "gv", "gz", "k",
                ...
                var name4                                                   = new string[] { "a", "e", "i", "", "a", "e", "i", "o", "u", "o", "u", "a", "e", "i", "o", "u", "oi", "ie", "ai", "ei", "eo", "ui" };
                var name5                                                   = new string[] { "ks", "l", "ls", "n", "d", "ds", "k", "ns", "ts", "x" };
                ...
                if (name3[r3] == "")
                    ...
                    while (name4[r4] == "")
                        r4 = Random.Range(0, name4.Length);
