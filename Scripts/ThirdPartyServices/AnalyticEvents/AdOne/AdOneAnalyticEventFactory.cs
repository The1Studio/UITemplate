...
namespace TheOneStudio.UITemplate.UITemplate.Scripts.ThirdPartyServices.AnalyticEvents.AdOne
{
    ...
    public class AdOneAnalyticEventFactory : BaseAnalyticEventFactory
    {
        ...
        [Preserve]
        public AdOneAnalyticEventFactory(UITemplateLevelDataController uiTemplateLevelDataController)
        {
        ...
        public override IEvent LevelStart(int level, int gold, int totalLevelsPlayed, long timeBetweenLastEvent, int gameModeId, int totalLevelsTypePlayed) { return new LevelStart(level, this.uiTemplateLevelDataController.GetLevelData(level).LevelStatus == LevelData.Status.Passed); }
