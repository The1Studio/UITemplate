namespace TheOneStudio.UITemplate.UITemplate.Utils
{
    ...
    public static class MainCameraUtils
    {
        ...
        public static void MoveCamera(Vector2 position, float duration, Ease easing) { GetMainCam.transform.DOMove( new Vector3(position.x, position.y, -10), duration).SetEase(easing).SetAutoKill(true); }
