...
namespace BuildReportTool
{
    ...
    /// </summary>
    [Serializable]
    [XmlRoot("BuildReportToolOptions")]
    public class SavedOptions
    {
        ...
        public List<IgnorePattern> IgnorePatternsForUnused = new();
        ...
        public void OnBeforeSave()
        {
            ...
            this.BuildReportFolderName = this.BuildReportFolderName.Replace(":", string.Empty);
            this.BuildReportFolderName = this.BuildReportFolderName.Replace("*", string.Empty);
            this.BuildReportFolderName = this.BuildReportFolderName.Replace("?", string.Empty);
            this.BuildReportFolderName = this.BuildReportFolderName.Replace("\"", string.Empty);
            this.BuildReportFolderName = this.BuildReportFolderName.Replace("<", string.Empty);
        ...
        public static void Save(string savePath, SavedOptions optionsToSave)
        {
            ...
            var        x      = new XmlSerializer(typeof(SavedOptions));
    ...
    public static class Options
    {
        ...
        // =======================================================
        //
        private static SavedOptions _savedOptions;
        private static string       _foundPathForSavedOptions;
        private const  string       SAVED_OPTIONS_FILENAME = "BuildReportToolOptions.xml";

        private static string DefaultOptionsPath => string.Format("{0}ProjectSettings/{1}", Util.GetProjectPath(Application.dataPath), SAVED_OPTIONS_FILENAME);

        private static bool IsBuildReportInRegularPaths =>
            Directory.Exists(string.Format("{0}/BuildReport", Application.dataPath)) || Directory.Exists(string.Format("{0}/Plugins/BuildReport", Application.dataPath));

        public static string FoundPathForSavedOptions => _foundPathForSavedOptions;

        private static void InitializeOptionsIfNeeded()
        {
            if (_savedOptions == null) _foundPathForSavedOptions = string.Empty;
            ...
            if (string.IsNullOrEmpty(_foundPathForSavedOptions))
            {
                ...
                var optionsInPluginsBuildReport = string.Format("{0}/Plugins/BuildReport/{1}",
                ...
                var optionsInMyDocs = string.Format("{0}/{1}/{2}",
                    Util.GetUserHomeFolder(),
                    BUILD_REPORTS_DEFAULT_FOLDER_NAME,
                    SAVED_OPTIONS_FILENAME);
            ...
            if (_savedOptions == null)
            {
                ...
                if (!string.IsNullOrEmpty(defaultFolder) && !Directory.Exists(defaultFolder)) Directory.CreateDirectory(defaultFolder);
        ...
        {
            if (string.IsNullOrEmpty(_foundPathForSavedOptions)) return;
        ...
        public static FilterToUseType GetOptionFilterToUse()
        {
            ...
            {
                case 0: return FilterToUseType.UseConfiguredFile;
                case 1: return FilterToUseType.UseEmbedded;
            }
        ...
        private static SearchType _previousSearchType = SearchType;

        public static bool HasSearchTypeChanged => _previousSearchType != SearchType;
        ...
        public static SearchType SearchType
        {
            get
            {
                ...
                {
                    case SavedOptions.SEARCH_METHOD_REGEX: return SearchType.Regex;
                    case SavedOptions.SEARCH_METHOD_FUZZY: return SearchType.Fuzzy;
                    default:                               return SearchType.Basic;
                }
            }
            set
            {
        ...
        public static bool SearchTypeIsBasic => SearchTypeInt == SEARCH_TYPE_BASIC;

        public static bool SearchTypeIsRegex => SearchTypeInt == SEARCH_TYPE_REGEX;

        public static bool SearchTypeIsFuzzy => SearchTypeInt == SEARCH_TYPE_FUZZY;
        ...
        public static int SearchTypeInt
        {
            get
            {
                ...
                switch (_savedOptions.SearchType)
                {
                    case SavedOptions.SEARCH_METHOD_REGEX: return SEARCH_TYPE_REGEX;
                    case SavedOptions.SEARCH_METHOD_FUZZY: return SEARCH_TYPE_FUZZY;
                    default:                               return SEARCH_TYPE_BASIC;
                }
            }
            set
            {
        ...
        public static bool IsCalculationLevelAtFull(
            bool includeUsedAssets,
            bool includeUnusedAssets,
        ...
        public static bool IsCalculationLevelAtNoUnusedPrefabs(
            bool includeUsedAssets,
            bool includeUnusedAssets,
            bool includeUnusedPrefabs
        )
        ...
        public static bool IsCalculationLevelAtNoUnusedAssets(
            bool includeUsedAssets,
            bool includeUnusedAssets,
            bool includeUnusedPrefabs
        )
        ...
        public static bool IsCalculationLevelAtOverviewOnly(
            bool includeUsedAssets,
            bool includeUnusedAssets,
            bool includeUnusedPrefabs
        )
        ...
        public static bool IsCurrentCalculationLevelAtFull =>
            IsCalculationLevelAtFull(IncludeUsedAssetsInReportCreation,
                IncludeUnusedAssetsInReportCreation,
                IncludeUnusedPrefabsInReportCreation);

        public static bool IsCurrentCalculationLevelAtNoUnusedPrefabs =>
            IsCalculationLevelAtNoUnusedPrefabs(IncludeUsedAssetsInReportCreation,
                IncludeUnusedAssetsInReportCreation,
                IncludeUnusedPrefabsInReportCreation);

        public static bool IsCurrentCalculationLevelAtNoUnusedAssets =>
            IsCalculationLevelAtNoUnusedAssets(IncludeUsedAssetsInReportCreation,
                IncludeUnusedAssetsInReportCreation,
                IncludeUnusedPrefabsInReportCreation);

        public static bool IsCurrentCalculationLevelAtOverviewOnly =>
            IsCalculationLevelAtOverviewOnly(IncludeUsedAssetsInReportCreation,
                IncludeUnusedAssetsInReportCreation,
                IncludeUnusedPrefabsInReportCreation);
        ...
        public static bool ShouldShowWindowAfterBuild => !IsInBatchMode && AutoShowWindowAfterNormalBuild;
