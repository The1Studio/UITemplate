namespace TheOneStudio.UITemplate.UITemplate.ThirdPartyServices.AnalyticEvents
{
    ...
    public abstract class BaseAnalyticEventFactory : IAnalyticEventFactory
    {
        ...
        //Level
        public virtual IEvent LevelStart(int level, int gold, int totalLevelsPlayed, long timeBetweenLastEvent, int gameModeId, int totalLevelsTypePlayed) => new LevelStart(level, gold, totalLevelsPlayed, timeBetweenLastEvent, gameModeId, totalLevelsTypePlayed);

        public virtual IEvent LevelEnd(int level, string status, int gameModeId, long timePlay, long timeBetweenLastEvent, Dictionary<string, object> spentResources) => new LevelEnd(level, status, gameModeId, timePlay, timeBetweenLastEvent, spentResources);
        ...
        public virtual IEvent EarnResource(string resourceId, long value, string source, Dictionary<string, object> spentResources, long timeBetweenLastEvent) => new EarnResource(resourceId, value, source, spentResources, timeBetweenLastEvent);

        public virtual IEvent SpendResource(string resourceId, long value, string location, long timeBetweenLastEvent) => new SpendResource(resourceId, value, location, timeBetweenLastEvent);
