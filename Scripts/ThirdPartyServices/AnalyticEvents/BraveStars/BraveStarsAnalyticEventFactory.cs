...
namespace TheOneStudio.UITemplate.UITemplate.ThirdPartyServices.AnalyticEvents.BraveStars
{
    ...
    public class BraveStarsAnalyticEventFactory : BaseAnalyticEventFactory
    {
        ...
        [Preserve]
        public BraveStarsAnalyticEventFactory()
        {
        ...
        public override IEvent LevelStart(int level, int gold, int totalLevelsPlayed, long timeBetweenLastEvent, int gameModeId, int totalLevelsTypePlayed) => new CustomEvent { EventName = $"start_level_{level}" };
