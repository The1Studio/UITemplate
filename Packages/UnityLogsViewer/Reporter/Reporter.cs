...
public class Reporter : MonoBehaviour
{
    ...
    void drawToolBar()
    {
        ...
        if (showClearOnNewSceneLoadedButton &&
            GUILayout.Button(clearOnNewSceneContent, (clearOnNewSceneLoaded) ? buttonActiveStyle : barStyle, GUILayout.Width(size.x * 2), GUILayout.Height(size.y * 2)))
        {
    ...
    public void OnGUIDraw()
    {
        ...
        logsRect.x      = 0f;
        logsRect.y      = safeAreaHeight + size.y * 2f;
        ...
        stackRect.y        = safeAreaHeight +Screen.height * 0.75f;
        stackRect.width    = Screen.width;
        stackRect.height   = Screen.height * 0.25f - size.y;

        detailRect.x      = 0f;
        detailRect.y      = safeAreaHeight +Screen.height - size.y * 3;
    ...
    void CaptureLog(string condition, string stacktrace, LogType type) { AddLog(condition, stacktrace, type); }
