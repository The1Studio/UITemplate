namespace TheOneStudio.UITemplate.UITemplate.Services
{
    ...
    public class LockInputService : IInitializable
    {
        ...
        public void Initialize()
        {
            ...
            this.signalBus.Subscribe<InterstitialAdLoadFailedSignal>(() => this.SetLockInput(true));
            ...
            this.signalBus.Subscribe<RewardedAdLoadFailedSignal>(() => this.SetLockInput(true));
        }
