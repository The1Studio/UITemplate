...
{
    [Serializable]
    [System.Xml.Serialization.XmlRoot("TextureData")]
    public class TextureData : IDataFile
    {
        ...
        {
            return Util.GetTextureDataDefaultFilename(this.ProjectName, this.BuildType, this.TimeGot);
        }
        ...
        public bool HasContents => this._textureData.Count > 0;
...
The original width and height of the image <i>before</i> it was resized by the <b><color=white>Max Texture Size</color></b> limit and <b><color=white>Non-Power of Two Scale</color></b> restrictions.";
        ...
        public static string GetTooltipTextFromId(DataId textureDataId)
        {
            switch (textureDataId)
            {
                ...
                case DataId.AlphaIsTransparency: return TOOLTIP_TEXT_ALPHA_IS_TRANSPARENCY;
                case DataId.IgnorePngGamma:      return TOOLTIP_TEXT_IGNORE_PNG_GAMMA;
                case DataId.NPotScale:           return TOOLTIP_TEXT_NPOT_SCALE;
                case DataId.IsReadable:          return TOOLTIP_TEXT_IS_READABLE;
                // -----------------------------------------------
                case DataId.MipMapGenerated:         return TOOLTIP_TEXT_MIPMAP_GENERATED;
                case DataId.MipMapFilter:            return TOOLTIP_TEXT_MIPMAP_FILTER;
                case DataId.StreamingMipMaps:        return TOOLTIP_TEXT_STREAMING_MIPMAPS;
                case DataId.BorderMipMaps:           return TOOLTIP_TEXT_BORDER_MIPMAPS;
                case DataId.PreserveCoverageMipMaps: return TOOLTIP_TEXT_PRESERVE_COVERAGE_MIPMAPS;
                case DataId.FadeOutMipMaps:          return TOOLTIP_TEXT_FADE_MIPMAPS;
                // -----------------------------------------------
                case DataId.SpriteImportMode:          return TOOLTIP_TEXT_SPRITE_IMPORT_MODE;
                case DataId.SpritePackingTag:          return TOOLTIP_TEXT_SPRITE_PACKING_TAG;
                case DataId.SpritePixelsPerUnit:       return TOOLTIP_TEXT_SPRITE_PIXELS_PER_UNIT;
                case DataId.QualifiesForSpritePacking: return TOOLTIP_TEXT_SPRITE_QUALIFIES_FOR_PACKING;
                // -----------------------------------------------
                case DataId.WrapMode:   return TOOLTIP_TEXT_WRAP_MODE;
                ...
                case DataId.FilterMode: return TOOLTIP_TEXT_FILTER_MODE;
                case DataId.AnisoLevel: return TOOLTIP_TEXT_ANISO_LEVEL;
                // -----------------------------------------------
                case DataId.MaxTextureSize:         return TOOLTIP_TEXT_MAX_SIZE;
                case DataId.TextureResizeAlgorithm: return TOOLTIP_TEXT_RESIZE_ALGO;
                case DataId.TextureFormat:          return TOOLTIP_TEXT_FORMAT;
                case DataId.CompressionType:        return TOOLTIP_TEXT_COMPRESSION_TYPE;
                case DataId.CompressionIsCrunched:  return TOOLTIP_TEXT_COMPRESSION_CRUNCHED;
                case DataId.CompressionQuality:     return TOOLTIP_TEXT_COMPRESSION_QUALITY;
                // -----------------------------------------------
                case DataId.ImportedWidthAndHeight: return TOOLTIP_TEXT_IMPORTED_WIDTH_AND_HEIGHT;
                case DataId.RealWidthAndHeight:     return TOOLTIP_TEXT_REAL_WIDTH_AND_HEIGHT;
                // -----------------------------------------------
                default: return null;
            }
        }
        ...
        public struct Entry
        {
            ...
            /// </summary>
            private int _shownMaxTextureSize;
            ...
            /// </summary>
            private string _shownMaxTextureSizeLabel;

            private string _overridingMaxTextureSizeMessage;
            ...
            /// it will have an asterisk at the end.
            /// </summary>
            private string _shownTextureResizeAlgorithm;

            private string _overridingTextureResizeAlgorithmMessage;
            ...
            /// it will have an asterisk at the end.
            /// </summary>
            private string _shownTextureFormat;

            private string _overridingTextureFormatMessage;
            ...
            /// it will have an asterisk at the end.
            /// </summary>
            private string _shownCompressionType;

            private string _overridingCompressionTypeMessage;
            ...
            /// depending on whether <see cref="PlatformSettingsOverriden"/> is true or not.
            /// </summary>
            private bool _shownCompressionIsCrunched;
            ...
            /// it will have an asterisk at the end.
            /// </summary>
            private string _shownCompressionIsCrunchedLabel;

            private string _overridingCompressionIsCrunchedMessage;
            ...
            /// depending on whether <see cref="PlatformSettingsOverriden"/> is true or not.
            /// </summary>
            private int _shownCompressionQuality;
            ...
            /// it will have an asterisk at the end.
            /// </summary>
            private string _shownCompressionQualityLabel;

            private string _overridingCompressionQualityMessage;

            // ----------------------------------------

            public int GetShownMaxTextureSize()
            {
                return this._shownMaxTextureSize;
            }

            public string GetShownTextureResizeAlgorithm()
            {
                return this._shownTextureResizeAlgorithm;
            }

            public string GetShownTextureFormat()
            {
                return this._shownTextureFormat;
            }

            public string GetShownCompressionType()
            {
                return this._shownCompressionType;
            }

            public bool GetShownCompressionIsCrunched()
            {
                return this._shownCompressionIsCrunched;
            }

            public int GetShownCompressionQuality()
            {
                return this._shownCompressionQuality;
            }

            public int GetImportedPixelCount()
            {
                return this.ImportedWidth * this.ImportedHeight;
            }
            ...
            public Entry(string n = null)
            {
                ...
                this.IgnorePngGamma      = false;

                this.NPotScale               = null;
                this.IsReadable              = false;
                this.MipMapGenerated         = false;
                this.MipMapFilter            = null;
                this.StreamingMipMaps        = false;
                this.BorderMipMaps           = false;
                this.PreserveCoverageMipMaps = false;
                this.FadeOutMipMaps          = false;

                this.SpriteImportMode          = null;
                this.SpritePackingTag          = null;
                this.SpritePixelsPerUnit       = 0;
                this.QualifiesForSpritePacking = false;
                ...
                this.TextureResizeAlgorithm = null;
                this.TextureFormat          = null;
                this.CompressionType        = null;
                this.CompressionIsCrunched  = false;
                this.CompressionQuality     = 0;

                this.PlatformSettingsOverriden        = false;
                this.OverridingMaxTextureSize         = 0;
                this.OverridingTextureResizeAlgorithm = null;
                this.OverridingTextureFormat          = null;
                this.OverridingCompressionType        = null;
                this.OverridingCompressionIsCrunched  = false;
                this.OverridingCompressionQuality     = 0;
                ...
                this._shownMaxTextureSize             = 0;
                this._shownMaxTextureSizeLabel        = null;
                this._shownTextureResizeAlgorithm     = null;
                this._shownTextureFormat              = null;
                this._shownCompressionType            = null;
                this._shownCompressionIsCrunched      = false;
                this._shownCompressionIsCrunchedLabel = null;
                this._shownCompressionQuality         = 0;
                this._shownCompressionQualityLabel    = null;

                this._overridingMaxTextureSizeMessage         = null;
                this._overridingTextureResizeAlgorithmMessage = null;
                this._overridingTextureFormatMessage          = null;
                this._overridingCompressionTypeMessage        = null;
                this._overridingCompressionIsCrunchedMessage  = null;
                this._overridingCompressionQualityMessage     = null;
            }

            public void UpdateShownSettings(string platformName)
            {
                if (!this.PlatformSettingsOverriden)
                {
                    this._shownMaxTextureSize             = this.MaxTextureSize;
                    this._shownMaxTextureSizeLabel        = this.MaxTextureSize.ToString();
                    this._overridingMaxTextureSizeMessage = null;

                    this._shownTextureResizeAlgorithm             = this.TextureResizeAlgorithm;
                    this._overridingTextureResizeAlgorithmMessage = null;

                    this._shownTextureFormat             = this.TextureFormat;
                    this._overridingTextureFormatMessage = null;

                    this._shownCompressionType             = this.CompressionType;
                    this._overridingCompressionTypeMessage = null;

                    this._shownCompressionIsCrunched             = this.CompressionIsCrunched;
                    this._shownCompressionIsCrunchedLabel        = this.CompressionIsCrunched.ToYesNo();
                    this._overridingCompressionIsCrunchedMessage = null;

                    this._shownCompressionQuality             = this.CompressionQuality;
                    this._shownCompressionQualityLabel        = this.CompressionQuality.ToString();
                    this._overridingCompressionQualityMessage = null;

                    return;
                }

                if (this.OverridingMaxTextureSize != this.MaxTextureSize)
                {
                    this._shownMaxTextureSize      = this.OverridingMaxTextureSize;
                    this._shownMaxTextureSizeLabel = string.Format("{0}*", this.OverridingMaxTextureSize.ToString());

                    if (string.IsNullOrEmpty(platformName))
                        this._overridingMaxTextureSizeMessage =
                            string.Format("<b><color=white>Max Texture Size</color></b> has been overriden from <b><color=white>{0}</color></b> to <b><color=white>{1}</color></b>",
                                this.MaxTextureSize.ToString(),
                                this.OverridingMaxTextureSize.ToString());
                    else
                        this._overridingMaxTextureSizeMessage =
                ...
                if (!string.IsNullOrEmpty(this.OverridingTextureResizeAlgorithm) && this.OverridingTextureResizeAlgorithm != this.TextureResizeAlgorithm)
                {
                    this._shownTextureResizeAlgorithm = string.Format("{0}*", this.OverridingTextureResizeAlgorithm);

                    if (string.IsNullOrEmpty(platformName))
                        this._overridingTextureResizeAlgorithmMessage =
                            string.Format("<b><color=white>Texture Resize Algorithm</color></b> has been overriden from <b><color=white>{0}</color></b> to <b><color=white>{1}</color></b>",
                                this.TextureResizeAlgorithm,
                                this.OverridingTextureResizeAlgorithm);
                    else
                        this._overridingTextureResizeAlgorithmMessage =
                ...
                if (!string.IsNullOrEmpty(this.OverridingTextureFormat) && this.OverridingTextureFormat != this.TextureFormat)
                {
                    this._shownTextureFormat = string.Format("{0}*", this.OverridingTextureFormat);

                    if (string.IsNullOrEmpty(platformName))
                        this._overridingTextureFormatMessage =
                ...
                if (!string.IsNullOrEmpty(this.OverridingCompressionType) && this.OverridingCompressionType != this.CompressionType)
                {
                    this._shownCompressionType = string.Format("{0}*", this.OverridingCompressionType);

                    if (string.IsNullOrEmpty(platformName))
                        this._overridingCompressionTypeMessage =
                            string.Format("<b><color=white>Compression Type</color></b> has been overriden from <b><color=white>{0}</color></b> to <b><color=white>{1}</color></b>",
                                ...
                                this.OverridingCompressionType);
                    else
                        this._overridingCompressionTypeMessage =
                ...
                if (this.OverridingCompressionIsCrunched != this.CompressionIsCrunched)
                {
                    this._shownCompressionIsCrunched      = this.OverridingCompressionIsCrunched;
                    this._shownCompressionIsCrunchedLabel = string.Format("{0}*", this.OverridingCompressionIsCrunched.ToYesNo());

                    if (string.IsNullOrEmpty(platformName))
                        this._overridingCompressionIsCrunchedMessage =
                            string.Format("<b><color=white>Compression is Crunched</color></b> has been overriden from <b><color=white>{0}</color></b> to <b><color=white>{1}</color></b>",
                                this.CompressionIsCrunched.ToYesNo(),
                                this.OverridingCompressionIsCrunched.ToYesNo());
                    else
                        this._overridingCompressionIsCrunchedMessage =
                ...
                if (this.OverridingCompressionQuality != this.CompressionQuality)
                {
                    this._shownCompressionQuality      = this.OverridingCompressionQuality;
                    this._shownCompressionQualityLabel = string.Format("{0}*", this.OverridingCompressionQuality.ToString());

                    if (string.IsNullOrEmpty(platformName))
                        this._overridingCompressionQualityMessage =
                            string.Format("<b><color=white>Compression Quality</color></b> has been overriden from <b><color=white>{0}</color></b> to <b><color=white>{1}</color></b>",
                                this.CompressionQuality.ToString(),
                                this.OverridingCompressionQuality.ToString());
                    else
                        this._overridingCompressionQualityMessage =
            ...
            public string ToDisplayedValue(DataId dataId)
            {
                switch (dataId)
                {
                    case DataId.TextureType:         return this.TextureType;
                    case DataId.IsSRGB:              return this.IsSRGB.ToYesNo();
                    case DataId.AlphaSource:         return this.AlphaSource;
                    case DataId.AlphaIsTransparency: return this.AlphaIsTransparency.ToYesNo();
                    case DataId.IgnorePngGamma:      return this.IgnorePngGamma.ToYesNo();
                    case DataId.NPotScale:           return this.NPotScale;
                    case DataId.IsReadable:          return this.IsReadable.ToYesNo();
                    // ------------------------
                    case DataId.MipMapGenerated:         return this.MipMapGenerated.ToYesNo();
                    case DataId.MipMapFilter:            return this.MipMapFilter;
                    case DataId.StreamingMipMaps:        return this.StreamingMipMaps.ToYesNo();
                    case DataId.BorderMipMaps:           return this.BorderMipMaps.ToYesNo();
                    case DataId.PreserveCoverageMipMaps: return this.PreserveCoverageMipMaps.ToYesNo();
                    case DataId.FadeOutMipMaps:          return this.FadeOutMipMaps.ToYesNo();
                    // ------------------------
                    case DataId.SpriteImportMode:          return this.SpriteImportMode;
                    case DataId.QualifiesForSpritePacking: return this.QualifiesForSpritePacking.ToYesNo();
                    case DataId.SpritePackingTag:          return this.SpritePackingTag;
                    case DataId.SpritePixelsPerUnit:       return this.SpritePixelsPerUnit.ToString(CultureInfo.InvariantCulture);
                    // ------------------------
                    case DataId.WrapMode:   return this.WrapMode;
                    case DataId.WrapModeU:  return this.WrapModeU;
                    case DataId.WrapModeV:  return this.WrapModeV;
                    case DataId.WrapModeW:  return this.WrapModeW;
                    case DataId.FilterMode: return this.FilterMode;
                    case DataId.AnisoLevel: return this.AnisoLevel.ToString();
                    // ------------------------
                    case DataId.MaxTextureSize:         return this._shownMaxTextureSizeLabel;
                    case DataId.TextureResizeAlgorithm: return this._shownTextureResizeAlgorithm;
                    case DataId.TextureFormat:          return this._shownTextureFormat;
                    case DataId.CompressionType:        return this._shownCompressionType;
                    case DataId.CompressionIsCrunched:  return this._shownCompressionIsCrunchedLabel;
                    case DataId.CompressionQuality:     return this._shownCompressionQualityLabel;
                    // ------------------------
                    case DataId.ImportedWidthAndHeight: return string.Format("{0}x{1}", this.ImportedWidth.ToString(), this.ImportedHeight.ToString());
                    case DataId.RealWidthAndHeight:     return string.Format("{0}x{1}", this.RealWidth.ToString(), this.RealHeight.ToString());
                    // ------------------------
                    default: return string.Empty;
                }
            }

            public bool IsImportedWidthAndHeightDifferentFromReal => this.ImportedWidth != this.RealWidth || this.ImportedHeight != this.RealHeight;

            public bool IsOverriden(DataId dataId)
            {
                if (!this.PlatformSettingsOverriden) return false;

                switch (dataId)
                {
                    // ------------------------
                    case DataId.MaxTextureSize:         return this.OverridingMaxTextureSize != this.MaxTextureSize;
                    case DataId.TextureResizeAlgorithm: return this.OverridingTextureResizeAlgorithm != this.TextureResizeAlgorithm;
                    case DataId.TextureFormat:          return this.OverridingTextureFormat != this.TextureFormat;
                    case DataId.CompressionType:        return this.OverridingCompressionType != this.CompressionType;
                    case DataId.CompressionIsCrunched:  return this.OverridingCompressionIsCrunched != this.CompressionIsCrunched;
                    case DataId.CompressionQuality:     return this.OverridingCompressionQuality != this.CompressionQuality;
                    // ------------------------
            ...
            {
                if (!this.PlatformSettingsOverriden) return null;

                switch (dataId)
                {
                    // ------------------------
                    case DataId.MaxTextureSize:         return this._overridingMaxTextureSizeMessage;
                    case DataId.TextureResizeAlgorithm: return this._overridingTextureResizeAlgorithmMessage;
                    case DataId.TextureFormat:          return this._overridingTextureFormatMessage;
                    case DataId.CompressionType:        return this._overridingCompressionTypeMessage;
                    case DataId.CompressionIsCrunched:  return this._overridingCompressionIsCrunchedMessage;
                    case DataId.CompressionQuality:     return this._overridingCompressionQualityMessage;
                    // ------------------------
                    default: return null;
                }
            }
        ...
        private Dictionary<string, Entry> _textureData = new();
        ...
        public void OnBeforeSave()
        {
            ...
            this.Assets.AddRange(this._textureData.Keys);
            ...
            this.Data.AddRange(this._textureData.Values);
        }
        ...
        public void OnAfterLoad()
        {
            ...
            var platformName = GetPlatformNameFromBuildType(this.BuildType);
            ...
            for (var n = 0; n < len; ++n)
            {
                ...
                this._textureData.Add(this.Assets[n], this.Data[n]);
            }
        }
        ...
        public static string GetPlatformNameFromBuildType(string buildType)
        {
            ...
            if (buildType.IndexOf("Windows", StringComparison.Ordinal) != -1 && buildType.IndexOf("Store", StringComparison.Ordinal) != -1) return "Windows Store Apps";

            if (buildType.IndexOf("Windows", StringComparison.Ordinal) != -1 || buildType.IndexOf("Linux", StringComparison.Ordinal) != -1 || buildType.IndexOf("Mac", StringComparison.Ordinal) != -1) return "Standalone";

            if (buildType.IndexOf("Android", StringComparison.Ordinal) != -1) return "Android";

            if (buildType.IndexOf("iPhone", StringComparison.Ordinal) != -1 || buildType.IndexOf("iOS", StringComparison.Ordinal) != -1) return "iPhone";

            if (buildType.IndexOf("Tizen", StringComparison.Ordinal) != -1) return "Tizen";

            if (buildType.IndexOf("WebPlayer", StringComparison.Ordinal) != -1) return "Web";

            if (buildType.IndexOf("WebGL", StringComparison.Ordinal) != -1) return "WebGL";

            if (buildType.IndexOf("XBoxOne", StringComparison.OrdinalIgnoreCase) != -1) return "XboxOne";

            if (buildType.IndexOf("PS4", StringComparison.OrdinalIgnoreCase) != -1) return "PS4";

            if (buildType.IndexOf("PSVitaNative", StringComparison.OrdinalIgnoreCase) != -1) return "PSP2";

            if (buildType.IndexOf("WiiU", StringComparison.OrdinalIgnoreCase) != -1) return "WiiU";

            if (buildType.IndexOf("Nintendo", StringComparison.OrdinalIgnoreCase) != -1 && buildType.IndexOf("3DS", StringComparison.OrdinalIgnoreCase) != -1) return "Nintendo 3DS";

            if (buildType.IndexOf("Nintendo", StringComparison.OrdinalIgnoreCase) != -1 && buildType.IndexOf("Switch", StringComparison.OrdinalIgnoreCase) != -1) return "Nintendo Switch";
