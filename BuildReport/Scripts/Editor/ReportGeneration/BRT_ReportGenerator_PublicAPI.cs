...
namespace BuildReportTool
{
    public partial class ReportGenerator
    {
        ...
        {
            return CreateReport(buildPlayerOptions.scenes,
        ...
        )
        {
            ...
            {
                if (_lastKnownAssetDependencies == null) _lastKnownAssetDependencies = new();
            ...
            {
                if (_lastKnownTextureData == null) _lastKnownTextureData = new();
            ...
            {
                if (_lastKnownMeshData == null) _lastKnownMeshData = new();

                _lastKnownMeshData.TimeGot = timeBuildStarted;
            }
            else
            {
                if (_lastKnownMeshData != null) _lastKnownMeshData.Clear();
            }
