namespace TheOneStudio.UITemplate.UITemplate.Services
{
    ...
    public abstract class BaseUnityNotificationService : INotificationService, IDisposable
    {
        ...
        protected BaseUnityNotificationService(
            SignalBus                           signalBus,
        ...
        public async UniTask CheckPermission()
        {
            await this.PermissionService.RequestPermission(PermissionRequest.Notification);
        }
        ...
        public async void SetUpNotification()
        {
            ...
            try
            {
                ...
                foreach (var notificationData in uiTemplateNotificationRecords) tasks.Add(this.PrepareRemind(notificationData));
        ...
        private async UniTask<NotificationContent> PrepareRemind(UITemplateNotificationRecord record)
        {
            ...
            var itemRandom    = listCanRandom.RandomOrDefault();
        ...
        public async void SetupCustomNotification(string notificationId, TimeSpan? delayTime = null)
        {
            ...
            delayTime ??= new(notification.TimeToShow[0], notification.TimeToShow[1], notification.TimeToShow[2]);
            this.ScheduleNotification(notification, delayTime.Value, new(title, body));
        }
        ...
        public void SetChannelDescription(string val)
        {
