        ...
        private void OnScreenShowHandler(ScreenShowSignal obj)
        {
            ...
            foreach (var newButton in newButtons)
            {
                newButton.onClick.AddListener(() =>
                {
                    ...
                    if (!this.gameFeaturesSetting.clickButtonSound.IsNullOrEmpty() && !this.gameFeaturesSetting.buttonIgnores.Contains(newButton.name)) this.soundServices.PlaySound(this.gameFeaturesSetting.clickButtonSound);
                });
