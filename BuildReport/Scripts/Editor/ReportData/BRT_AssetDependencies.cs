...
namespace BuildReportTool
{
    ...
    /// </summary>
    [Serializable]
    [System.Xml.Serialization.XmlRoot("AssetDependencies")]
    public class AssetDependencies : IDataFile
    {
        ...
        {
            return Util.GetAssetDependenciesDefaultFilename(this.ProjectName, this.BuildType, this.TimeGot);
        }
        ...
        public bool HasContents => this._assetDependencies.Count > 0;

        // ==================================================================================

        private Dictionary<string, DependencyEntry> _assetDependencies = new();
        ...
        public void OnBeforeSave()
        {
            ...
            this.Assets.AddRange(this._assetDependencies.Keys);
            ...
            this.Dependencies.AddRange(this._assetDependencies.Values);
        }
        ...
        public void OnAfterLoad()
        {
            ...
            var len = Mathf.Min(this.Assets.Count, this.Dependencies.Count);
            for (var n = 0; n < len; ++n) this._assetDependencies.Add(this.Assets[n], this.Dependencies[n]);
        }
        ...
        public static void PopulateAssetEndUsers(
            string            rootAsset,
            List<GUIContent>  destination,
    ...
    public class DependencyEntry
    {
        ...
        /// </summary>
        public List<AssetUserFlattened> UsersFlattened = new();

        private List<GUIContent> _endUserLabels;

        public List<GUIContent> GetEndUserLabels()
        {
            if (this._endUserLabels == null) this._endUserLabels = new();

            return this._endUserLabels;
        }
    }
