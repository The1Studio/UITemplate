namespace UITemplate.Scripts.Publishers.Supersonic
{
    ...
    public class SupersonicLoadingScenePresenter : UITemplateLoadingScreenPresenter
    {
        protected SupersonicLoadingScenePresenter(
            ...
            : base(signalBus, logger, adService, blueprintManager, userDataManager, gameAssets, objectPoolManager, uiTemplateAdServiceWrapper, analyticServices, consentInformation)
        {
        }
