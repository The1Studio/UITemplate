...
namespace BuildReportTool
{
    ...
    public class UnityBuildSettings
    {
        ...
        public List<PackageEntry> PackageEntries = new();
        ...
        public List<BuiltInPackageEntry> BuiltInPackageEntries = new();

        // Derived Values
        // ---------------------------------------------------------------

        public bool HasValues => !string.IsNullOrEmpty(this.CompanyName) && !string.IsNullOrEmpty(this.NETApiCompatibilityLevel);
    }
}